...
public class EmployeeDoublyLinkedList {
    ...
    public boolean addBefore(Employee newEmployee, Employee existingEmployee) {
        ...
        //EmployeeNode existingEmployeeNode = new EmployeeNode(existingEmployee);
        ...
        System.out.println("initial head current employee: " + currentEmployee);

        while (currentEmployee!=null && !existingEmployee.equals(currentEmployee.getEmployee())) {
        ...
        currentEmployee.setPrevious(newEmployeeNode);
        newEmployeeNode.setPrevious(currentEmployee.getPrevious());
        newEmployeeNode.setNext(currentEmployee);

        if (currentEmployee.getPrevious() == null) {
